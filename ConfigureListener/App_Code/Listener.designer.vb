...
Partial Public Class ListenerDataContext
  ...
  End Sub
    ...
    End Sub
    Partial Private Sub InsertWebUserFinancialCategory(instance As Listener.WebUserFinancialCategory)
    End Sub
    Partial Private Sub UpdateWebUserFinancialCategory(instance As Listener.WebUserFinancialCategory)
    End Sub
    Partial Private Sub DeleteWebUserFinancialCategory(instance As Listener.WebUserFinancialCategory)
    End Sub
  ...
  #End Region
	...
	Public ReadOnly Property WebUserFinancialCategories() As System.Data.Linq.Table(Of Listener.WebUserFinancialCategory)
		Get
			Return Me.GetTable(Of Listener.WebUserFinancialCategory)
		End Get
	End Property
	...
	<Global.System.Data.Linq.Mapping.FunctionAttribute(Name:="dbo.VerifyNewColumns")>  _
	Public Function VerifyNewColumns() As Integer
