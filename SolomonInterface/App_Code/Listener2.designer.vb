...
Partial Public Class Listener2DataContext
  ...
  End Sub
    Partial Private Sub InsertWebUserCostCenter(instance As Listener2.WebUserCostCenter)
    End Sub
    Partial Private Sub UpdateWebUserCostCenter(instance As Listener2.WebUserCostCenter)
    End Sub
    Partial Private Sub DeleteWebUserCostCenter(instance As Listener2.WebUserCostCenter)
    End Sub
    Partial Private Sub InsertWebUser(instance As Listener2.WebUser)
    End Sub
    Partial Private Sub UpdateWebUser(instance As Listener2.WebUser)
    End Sub
    Partial Private Sub DeleteWebUser(instance As Listener2.WebUser)
    End Sub
    Partial Private Sub InsertDatalink(instance As Listener2.Datalink)
    End Sub
    Partial Private Sub UpdateDatalink(instance As Listener2.Datalink)
    End Sub
    Partial Private Sub DeleteDatalink(instance As Listener2.Datalink)
    End Sub
    Partial Private Sub InsertWebUserFinancialCategory(instance As Listener2.WebUserFinancialCategory)
    End Sub
    Partial Private Sub UpdateWebUserFinancialCategory(instance As Listener2.WebUserFinancialCategory)
    End Sub
    Partial Private Sub DeleteWebUserFinancialCategory(instance As Listener2.WebUserFinancialCategory)
    End Sub
    Partial Private Sub InsertSetting(instance As Listener2.Setting)
    End Sub
    Partial Private Sub UpdateSetting(instance As Listener2.Setting)
    End Sub
    Partial Private Sub DeleteSetting(instance As Listener2.Setting)
    End Sub
    Partial Private Sub InsertWebUserDesignation(instance As Listener2.WebUserDesignation)
    End Sub
    Partial Private Sub UpdateWebUserDesignation(instance As Listener2.WebUserDesignation)
    End Sub
    Partial Private Sub DeleteWebUserDesignation(instance As Listener2.WebUserDesignation)
    End Sub
  #End Region
	
	Public Sub New()
		MyBase.New(Global.SolomonInterface.My.MySettings.Default.acDatalinksConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public ReadOnly Property WebUserCostCenters() As System.Data.Linq.Table(Of Listener2.WebUserCostCenter)
		Get
			Return Me.GetTable(Of Listener2.WebUserCostCenter)
		End Get
	End Property
	
	Public ReadOnly Property WebUsers() As System.Data.Linq.Table(Of Listener2.WebUser)
		Get
			Return Me.GetTable(Of Listener2.WebUser)
		End Get
	End Property
	
	Public ReadOnly Property Datalinks() As System.Data.Linq.Table(Of Listener2.Datalink)
		Get
			Return Me.GetTable(Of Listener2.Datalink)
		End Get
	End Property
	
	Public ReadOnly Property WebUserFinancialCategories() As System.Data.Linq.Table(Of Listener2.WebUserFinancialCategory)
		Get
			Return Me.GetTable(Of Listener2.WebUserFinancialCategory)
		End Get
	End Property
	
	Public ReadOnly Property Settings() As System.Data.Linq.Table(Of Listener2.Setting)
		Get
			Return Me.GetTable(Of Listener2.Setting)
		End Get
	End Property
	
	Public ReadOnly Property WebUserDesignations() As System.Data.Linq.Table(Of Listener2.WebUserDesignation)
		Get
			Return Me.GetTable(Of Listener2.WebUserDesignation)
		End Get
	End Property
End Class
...
Namespace Listener2
	...
	<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.WebUserFinancialCategories")>  _
	Partial Public Class WebUserFinancialCategory
		Implements System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
		
		Private Shared emptyChangingEventArgs As PropertyChangingEventArgs = New PropertyChangingEventArgs(String.Empty)
		
		Private _FinCatId As Long
		
		Private _Category As String
		
		Private _StaffProfileCode As String
		
		Private _StaffProfileDesc As String
    ...
    Partial Private Sub OnCreated()
    End Sub
    Partial Private Sub OnFinCatIdChanging(value As Long)
    End Sub
    Partial Private Sub OnFinCatIdChanged()
    End Sub
    Partial Private Sub OnCategoryChanging(value As String)
    End Sub
    Partial Private Sub OnCategoryChanged()
    End Sub
    Partial Private Sub OnStaffProfileCodeChanging(value As String)
    End Sub
    Partial Private Sub OnStaffProfileCodeChanged()
    End Sub
    Partial Private Sub OnStaffProfileDescChanging(value As String)
    End Sub
    Partial Private Sub OnStaffProfileDescChanged()
    End Sub
    Partial Private Sub OnUsernameChanging(value As String)
    End Sub
    Partial Private Sub OnUsernameChanged()
    ...
    #End Region
		...
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_FinCatId", AutoSync:=AutoSync.OnInsert, DbType:="BigInt NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
		Public Property FinCatId() As Long
			Get
				Return Me._FinCatId
			End Get
			Set
				If ((Me._FinCatId = value)  _
							= false) Then
					Me.OnFinCatIdChanging(value)
					Me.SendPropertyChanging
					Me._FinCatId = value
					Me.SendPropertyChanged("FinCatId")
					Me.OnFinCatIdChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Category", DbType:="NVarChar(250)")>  _
		...
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_StaffProfileCode", DbType:="NVarChar(18)")>  _
		Public Property StaffProfileCode() As String
			Get
				Return Me._StaffProfileCode
			End Get
			Set
				If (String.Equals(Me._StaffProfileCode, value) = false) Then
					Me.OnStaffProfileCodeChanging(value)
					Me.SendPropertyChanging
					Me._StaffProfileCode = value
					Me.SendPropertyChanged("StaffProfileCode")
					Me.OnStaffProfileCodeChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_StaffProfileDesc", DbType:="NVarChar(250)")>  _
		Public Property StaffProfileDesc() As String
			Get
				Return Me._StaffProfileDesc
			End Get
			Set
				If (String.Equals(Me._StaffProfileDesc, value) = false) Then
					Me.OnStaffProfileDescChanging(value)
					Me.SendPropertyChanging
					Me._StaffProfileDesc = value
					Me.SendPropertyChanged("StaffProfileDesc")
					Me.OnStaffProfileDescChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Username", DbType:="NVarChar(250)")>  _
		Public Property Username() As String
			Get
				Return Me._Username
			End Get
